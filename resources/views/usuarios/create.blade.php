<x-layout.layout title="Crear usuario">

</x-layout.layout>
<h1 class="font-serif text-3xl text-sky-600 dark:text-sky-500 text-center">Crear usuario</h1>
<br>
<form class="max-w-sm mx-auto" action="{{route('usuarios.store')}}" method="POST">
    @csrf
    ...
    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre y apellido
        ...
        dark:focus:ring-blue-500 dark:focus:border-blue-500"
               name="nombre" placeholder="Santiago Torres P" type="text" value="{{old('nombre')}}">
    ...
    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Usuario
        ...
        <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
               name="Usuario" placeholder="Santi" type="text" value="{{old('Usuario')}}">
        {{--        Parar mostrar el error si el campo va vacio--}}
        @error('Usuario')
        <br>
        <p style="color: red">{{$message}}</p>
    ...
    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Numero de cedula
        <br>
        <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
               name="numeroCedula" placeholder="10228523" type="text" value="{{old('numeroCedula')}}">
        {{--        Parar mostrar el error si el campo va vacio--}}
        @error('numeroCedula')
        <br>
        <p style="color: red">{{$message}}</p>
    ...
    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Correo del usuario
        <br>
        <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
               name="correoUsuario" type="email" value="{{old('CorreoUsuario')}}">
    ...
    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Codigo
        <br>
        <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
               name="Codigo" type="text" placeholder="STP" value="{{old('Codigo')}}">
        @error('Codigo')
        <br>
        <p style="color: red">{{$message}}</p>
        @enderror
...
{{--        <br>--}}
{{--        <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                   name="Tipo" type="text" value="{{old('tipo')}}">--}}
{{--        @error('Tipo')--}}
{{--        <br>--}}
{{--        <p style="color: red">{{$message}}</p>--}}
{{--        @enderror--}}
