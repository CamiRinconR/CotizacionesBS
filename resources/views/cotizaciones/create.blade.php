...
<form class="max-w-sm mx-auto" action="{{route('cotizaciones.store')}}" method="POST">
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2 align-content-center">
        ...
        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
            Producto a cotizar
            <select class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer" name="ProductoId">
        ...
        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
            ...
            dark:focus:ring-blue-500 dark:focus:border-blue-500"
                   type="date" name="fechaPrevista">
        </label>

        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
            Estado del pedido
            <select class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer" name="Estado">
